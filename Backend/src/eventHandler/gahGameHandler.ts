...
import { checkIfPlayer, checkIfHost, checkIfLobby, checkCallback, isGeoBingoAgainstHumanity } from "../helpers/checkers"
...
export default (io: unknown, socket: MySocket) => {
  ...
  createListner(socket, "gah", [makeHost, newRandomCard, start, makeCapture, vote, score, endGame, setCaptureIndex, goToLobby, changeCountry, changeCard, report])
}
